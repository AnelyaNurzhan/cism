...
import TestsTabHeader from './test-tab/TestsTabHeader';
import TestSearchBar from './test-tab/TestSearchBar';
import TestsTable from './test-tab/TestsTable';
import { TestType } from './test-tab/types';
import { deleteTest } from './test-tab/TestDeleteHandler';
